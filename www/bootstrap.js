...
Ext.Loader.addClassPathMappings({
  ...
  "MyApp": "app",
  "sencha.login.LoginPanel": "packages/LoginPanel/src/loginpanel.js"
});
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MyApp.controller.menu_btn_register": [],
  "MyApp.store.MyArrayStore": [],
  "MyApp.view.DetailsView": [],
  "MyApp.view.HTMLPanel": [],
  "MyApp.view.MyCarousel": [],
  "MyApp.view.MyLoginPanel": [],
  "MyApp.view.MyMenu": [],
  "MyApp.view.MyNavigationView1": [],
  "MyApp.view.Mytest": [],
  "MyApp.view.html": [],
  "MyApp.view.mainLayout": [],
  "sencha.login.LoginPanel": []
});
